	                ...
	                <table>
	                    <tr>
	                        <td>
	                            <![endif]-->
	                            <ul id="subnavlist" class="dropdown-menu">
	                                <li><a href="#London" onClick="openCity(event, 'Ealtas')">Altas</a></li>
				                    <li><a href="#Tokyo" onClick="openCity(event, 'Ebajas')">Bajas</a></li>
...
<div id="Ealtas" class="tabcontent">
  <h3>Envio de Proyecto</h3>
  <label><b>Seleccionar archivo en formato <strong>PDF</strong>para enviar</b></label><br>
...
if(isset($_POST['submit1'])){
  ...
  $query="update entrenadores set pdfnombre='$nombre', pdfmime='$tipo', pdfarchivo='$archivo' WHERE usuario='juan'";
...
<div id="Ebajas" class="tabcontent">
  <h3>Bajas</h3>
