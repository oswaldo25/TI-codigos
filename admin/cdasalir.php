...
.bgimg-1 {
  ...
  background-image: url("imagenes/mary10.jpg");
  min-height: 100%;
}
...
session_destroy();
	...
	echo "<script>alert('Gracias por usar CODE.');</script>";
...
<footer class="w3-center w3-black w3-padding-64">
 <!-- <a href="#home" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
  ...
  <p>Desarrollado <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-text-green"> por OCZ</a></p>
</footer>
