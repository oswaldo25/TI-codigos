...
.tabcontent {
  ...
  <body>
	...
	<section class="page-header">
        <div class="container">
	        <h1 class="title-ucol">CONTROL DE DEPORTISTAS CODE</h1>
	                ...
	                <table>
	                    <tr>
	                        <td>
	                            <![endif]-->
	                            <ul id="subnavlist" class="dropdown-menu">
	                                <li><a href="#London" onClick="openCity(event, 'Ealtas')" id="defaultOpen">Enviar</a></li>
				                    <li><a href="#Tokyo" onClick="openCity(event, 'Econsulta')">Conslutar</a></li>
				                    <li><a href="#Paris" onClick="openCity(event, 'Emodificacion')">Modificaciones</a></li>
				                    <li><a href="#Paris" onClick="openCity(event, 'Econsultas')">Consultas</a></li>
	                            </ul>
	                            <!--[if lte IE 6]>
	                        </td>
	                    </tr>
...
<div id="Ealtas" class="tabcontent">
  <h3>Proyecto Operativo</h3>
  <p>Enviar proyecto del Entrenador.</p>
		<form action="index.php" method="post" enctype="multipart/form-data">
 					
  					<input type="file" name="archivo" accept="application/pdf" required> <br>
                    
                   <!-- <input type="hidden" name="numerot" value="<?php echo $numerot ?>" >
					<input type="hidden" name="nombret" value="<?php echo $nombret ?>" > -->
                    <INPUT class="w3-button w3-black" TYPE="submit" name="submit1" value="Enviar">
...
print("Envio de proyecto.");
 $archivo=addslashes(file_get_contents($_FILES['archivo']['tmp_name']));
  $nombre=$_FILES['archivo']['name'];
  $tipo=$_FILES['archivo']['type'];
  
   $query="update entrenadores set pdfnombre='$nombre', pdfmime='$tipo', pdfarchivo='$archivo' WHERE usuario='kike'";
...
<div id="Econsulta" class="tabcontent">

  <h3>Consultas</h3>
  <p>Consulta por busqueda de usuario.</p> 
  <?php
...
$sql = "SELECT * FROM entrenadores WHERE usuario='juan'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo "usuario: " . $row["usuario"]. " - Name: " . $row["nombre"]. " " . $row["apellido"]. "<br>";
	$pdfnom= $row{"pdfnombre"};
	
	 echo "<a target='_blank' href='view.php?id=".$row['id']."&tabla="."entrenadores"."&mime="."pdfmime"."&archivo="."pdfarchivo"."'> $pdfnom </a>";		  
...
<div id="Emodificacion" class="tabcontent">
  <h3>Modificaciones</h3>
  <p>Tokyo is the capital of Japan.</p>
</div>
<div id="Econsultas" class="tabcontent">
  <h3>Consultas</h3>
  <p>Tokyo is the capital of Japan.</p> 
</div>
<script>
