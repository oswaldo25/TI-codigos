...
$sql=$link->query("SELECT * FROM  `entrenadores` where usuario='$usuario' and clave='$clave' and tipou='$tipou'" );
 
 // Verifica si existe la consulta.
if (!$sql) {
	echo "<script>alert('No existe ese docente. No se puede conectar');</script>";
     ...
     <div class="container "> 
     	<div id="path">
	            ...
	            <!-- <li><a href="cdeprincipal.php">Inicio</a></li> -->
				   <li>
				      <form action="cdeprincipal.php" method="post" enctype="multipart/form-data">
        ...
        <div id="sesion">
	        	<ol class="breadcrumb">
	            	<li>Bienvenido(a):</li>
	            <li class="user-name"><?php echo $usuario; ?></li>
	            <li><a href="cdesalir.php">Salir</a></li>
			</ol>
        </div>
     </div> <!--cierra path-->
    </section>
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <ul id="subnavlist" class="dropdown-menu">
				                   ...
				                   <!-- <li><a href="#Paris">Modificaciones</a></li>
