<?php 
 ...
 //Obliga al inicio de sesión (el equivalente a buscar en bd)
 $saml ->requireAuth(); 
 
 //Cuando inició sesión correctamente, se obtienen los atributos del usuario logueado (si no se loguea, no llega aquí).
 $atributos = $saml->getAttributes();
 
 $nombrea="{$atributos['displayName'][0]}";
  $numero="{$atributos['uTrabajador'][0]}";
	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-xs-12 main">	
        <div class="container2">
 			 ...
 			 <div class="content2">
   			  ...
   			  <p><strong>CODE</strong><br>Control de Deportistas Universitarios (CODEU).<br>Dirección General de Cultura Física y Deporte de la Universidad de Colima</p>
 			 </div>
		</div>      
