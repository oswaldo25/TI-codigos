 ...
 <div class="container c-principal">
  <div class="row p-contenido">
	<div class="col-xl-2 col-lg-4 col-md-4 col-xs-12 sidebar">
		...
		<form class="w3-container w3-card-4 w3-padding-16 w3-white" action="cdeconsulta.php" method="post">
...
if (mysqli_num_rows($result) > 0) {
  ...
  <table>
      ...
      <th>Numero</th>
      <th>Entrenador</th>
      <th>Enlace para ver Proyecto</th>
      <th>Archivo PDF</th>
    ...
    <tr>
      ...
      <th><?php echo "<a target='_blank' href='view.php?id=".$row['id']."&tabla=".$tabla."&mime="."pdfmime"."&archivo="."pdfarchivo"."'> Abrir Archivo PDF del Proyecto</a>" ?></th>
	  <!-- <th><?php echo "<a target='_blank' href='view.php?id=".$row['id']."&tabla=".$tabla."&mime="."pdfmime"."&archivo="."pdfarchivo"."'> $pdfnom </a>" ?></th> -->
      <th><?php echo "<embed src='data:".$row['pdfmime'].";base64,". base64_encode($row['pdfarchivo']) ."' width='300'>" ?></th>
           
    </tr>
  
<?php
  /*  echo "usuario: " . $row["usuario"]. " - Name: " . $row["nombre"]. " " . $row["apellido"]. "<a target='_blank' href='view.php?id=".$row['id']."&tabla="."entrenadores"."&mime="."pdfmime"."&archivo="."pdfarchivo"."'> $pdfnom </a>". "<embed src='data:".$row['pdfmime'].";base64,". base64_encode($row['pdfarchivo']) ."' width='300'>" ."<br>";*/ 
 	 }
	 ?>
	 </table>
</div>
