  ...
  <div class="row p-contenido">
	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-xs-12 main" align="center">	     
      ...
      <p>Enviar proyecto del Entrenador.</p>
		<form action="cdepoenviar.php" method="post" enctype="multipart/form-data">
...
<?php
	...
	if(isset($_POST['submit1'])){	
		$nomrec=$_POST['nombrec'];
		$correo=$_POST['correo'];
		 $archivo=addslashes(file_get_contents($_FILES['archivo']['tmp_name']));
  		$nombre=$_FILES['archivo']['name'];
 		 $tipo=$_FILES['archivo']['type'];
  
 	  $query="update entrenadores set pdfnombre='$nombre', pdfmime='$tipo', pdfarchivo='$archivo' WHERE numero='$numero'";
		$result = mysqli_query($link, $query);
		print("Proyecto Operativo Agregado al Entrenador.");
