  ...
  <body>
    ...
    <div class="container c-principal">
		<div class="row p-contenido">
			...
			<div class="col-xl-6 col-lg-4 col-md-4 col-xs-12 main"><!--Con contenido izquierdo y derecho -->
				<form action="index.php" method="post" enctype="multipart/form-data">
 					<label for="archivo"><b>Seleccionar archivo en formato <strong>PDF</strong></b></label><br>
...
print("Usuario agregado a la base.");
mysqli_close($link);
}
?>
